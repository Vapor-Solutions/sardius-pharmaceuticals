                                    ...
                                    <div class="pq-subscribe-from">
                                        ...
                                        <form id="form" class="form" action="{{ url('add-subscriber-email') }}"
                                            ...
                                            <div class="form-fields">
                                                ...
                                                @error('email')
                                                    <ul class=" alert alert-danger mt-3 text-danger"
                        ...
                        <div class="col-xl-4 col-md-6">
                            <div class="pq-footer-block">
                                ...
                                <div class="pq-footer-social">
                                    <ul>
                                        @if (env('COMPANY_FACEBOOK'))
                                            <li><a href="{{ env('COMPANY_FACEBOOK') }}"><i
                                                        class="fab fa-facebook-f"></i></a></li>
                                        @endif
                                        @if (env('COMPANY_TWITTER'))
                                            <li><a href="{{ env('COMPANY_TWITTER') }}"><i
                                                        class="fab fa-twitter"></i></a></li>
                                        @endif
                                        @if (env('COMPANY_LINKEDIN'))
                                            <li><a href="{{ env('COMPANY_LINKEDIN') }}"><i
                                                        class="fab fa-linkedin"></i></a></li>
                                        @endif
                                        @if (env('COMPANY_YOUTUBE'))
                                            <li><a href="{{ env('COMPANY_YOUTUBE') }}"><i
                                                        class="fab fa-youtube"></i></a></li>
                                        @endif
                                        @if (env('COMPANY_WHATSAPP'))
                                            <li><a href="{{ env('COMPANY_WHATSAPP') }}"><i
                            ...
                            <div class="pq-footer-block">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <ul class="pq-contact">
                                            <li>
                                                <a href="tel:{{ env('COMPANY_PHONE') }}"><i
