        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="pq-section pq-style-1 text-center">
                    ...
                    <h5 class="pq-section-title">Meet Our Directors</h5>
                </div>
            </div>
            <div class="col-lg-12 pb-dot-mt-0">
                <div class="owl-carousel owl-theme " data-dots="true" data-nav="false" data-desk_num="3"
                        ...
                        <div class="pq-team-box pq-style-1">
                            <div class="pq-team-img">
                                ...
                                <div class="pq-team-social">
                                    <ul>
                                        <li>
                                            <a class="facebook" href="" target="_blank"> <span
                                                    class="sr-only">Facebook</span> <i
                                                    class="fab fa-facebook"></i> </a>
                                        </li>
                                        <li>
                                            <a class="twitter" href="" target="_blank"> <span
                                                    class="sr-only">Twitter</span> <i class="fab fa-twitter"></i>
                                            </a>
                                        </li>
                                        <li>
                            ...
                            <div class="pq-team-info">
                                <h5 class="pq-member-name">
                                    <a href="doctor-1.html">Dr. Francis Karanja</a>
                                </h5>
                                <span class="pq-team-designation"></span>
                            </div>
                        </div>
                    </div>
                    <div class="item">
                        <div class="pq-team-box pq-style-1">
                            <div class="pq-team-img"> <img src="/images/team/2.jpg" class="img-fluid"
                                    alt="team-image">
                                <div class="pq-team-social">
                                    <ul>
                                        <li>
                            ...
                            <div class="pq-team-info">
                                <h5 class="pq-member-name">
                                    <a href="doctor-1.html">Dr. Winnie Ng'ang'a</a>
                                </h5>
                                <span class="pq-team-designation"></span>
                            </div>
                        </div>
                    ...
                    <div class="item">
                        <div class="pq-team-box pq-style-1">
                            <div class="pq-team-img"> <img src="/images/team/3.jpg" class="img-fluid"
                                    alt="team-image">
                                <div class="pq-team-social">
                                    <ul>
                                        <li>
                            ...
                            <div class="pq-team-info">
                                <h5 class="pq-member-name">
                                    <a href="doctor-1.html">David Swao</a>
                                </h5>
                                <span class="pq-team-designation"></span>
                            </div>
                        </div>
                    ...
                    <div class="item">
                        <div class="pq-team-box pq-style-1">
                            <div class="pq-team-img"> <img src="/images/team/4.jpg" class="img-fluid"
                                    alt="team-image">
                                <div class="pq-team-social">
                                    <ul>
                                        <li>
                    ...
                    <div class="item">
                        <div class="pq-team-box pq-style-1">
                            <div class="pq-team-img"> <img src="/images/team/5.jpg" class="ig-fluid"
                                    alt="team-image">
                                <div class="pq-team-social">
                                    <ul>
                                        <li>
