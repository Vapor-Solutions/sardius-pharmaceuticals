    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav me-auto">
                ...
                <x-jet-nav-link href="{{ route('admin.photo_categories.index') }}" :active="request()->routeIs('admin.photo_categories.index')">
                    {{ __('Photo Categories') }}
                </x-jet-nav-link>
                ...
                <x-jet-nav-link href="{{ route('admin.newsletters.index') }}" :active="request()->routeIs('admin.subscribers.index')">
                    {{ __('Newsletter') }}
                </x-jet-nav-link>
